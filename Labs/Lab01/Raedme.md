...
Однако в Cisco Packet Tracer 8.1.1 мак-адреса ПК будут отображаться после успешного ICMP-запроса к коммутатору. В реальности всё действительно будет так если настройки корректны.
