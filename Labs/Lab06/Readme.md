...
Это связано с тем что приоритет порта по умолчанию 128, к нему добавляется индентификатор с номером порта. Если ничего не менять  в приоритетете, то автоматически будет выбран порт с наименьшим номером.
